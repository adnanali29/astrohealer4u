        ...
        <div className="flex justify-between items-center h-20">
          ...
          >
            ...
            <div className="text-left">
              ...
              <span className="text-[8px] sm:text-[10px] tracking-wide text-purple-600 block font-semibold leading-none sm:leading-tight">Only i know what you are hiding 💫</span>
            </div>
          </button>
          ...
          <div className="flex items-center gap-1 sm:gap-3">
            ...
            <button
              ...
              className="relative p-1.5 sm:p-2.5 text-stone-600 hover:text-rose-500 hover:bg-rose-50 rounded-full transition-all group"
              title="Wishlist"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className={`w-4 h-4 sm:w-5 sm:h-5 transition-transform group-hover:scale-110 ${wishlist.length > 0 ? 'fill-rose-400 text-rose-500' : ''}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" />
              </svg>
              {wishlist.length > 0 && (
                <span className="absolute -top-0.5 -right-0.5 min-w-[0.95rem] h-[0.95rem] sm:min-w-[1.1rem] sm:h-[1.1rem] bg-rose-400 text-white text-[8px] sm:text-[9px] font-bold rounded-full flex items-center justify-center px-0.5">
                  {wishlist.length}
                </span>
              )}
            </button>
            ...
            <button
              ...
              className="relative p-1.5 sm:p-2.5 text-stone-600 hover:text-purple-700 hover:bg-purple-50 rounded-full transition-all group"
              title="Celestial Bundle"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 sm:w-5 sm:h-5 transition-transform group-hover:scale-110" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z" />
                <line x1="3" x2="21" y1="6" y2="6" />
                <path d="M16 10a4 4 0 0 1-8 0" />
              </svg>
              {cartCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 min-w-[0.95rem] h-[0.95rem] sm:min-w-[1.1rem] sm:h-[1.1rem] bg-purple-600 text-white text-[8px] sm:text-[9px] font-bold rounded-full flex items-center justify-center px-0.5">
                  {cartCount}
                </span>
              )}
            </button>
            ...
            <button
              ...
              className="p-1.5 sm:p-2.5 text-stone-600 hover:text-purple-700 hover:bg-purple-50 rounded-full transition-all md:hidden flex items-center justify-center"
