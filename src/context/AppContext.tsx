...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const [faqs, setFaqs] = useState<FaqItem[]>(FAQ_ITEMS_DEFAULT);
  ...
  const [shopCategories, setShopCategories] = useState<ShopCategory[]>(SHOP_CATEGORIES);
  const [shopSubProducts, setShopSubProducts] = useState<SubCrystalProduct[]>(CRYSTAL_SUB_PRODUCTS);
